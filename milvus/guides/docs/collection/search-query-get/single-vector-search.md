...
results = collection.search(
    # Replace with your query vector
    data=[[0.596255488017676, 0.803331289393417, 0.7889329600288849, 0.37180880411949024, 0.508569977301849]],
...
[
    ...
    {"id": 1448, "distance": 0.0372919924557209, "entity": {"doc_id": 8, "passage_id": 1448}},
    {"id": 2103, "distance": 0.0395108163356781, "entity": {"doc_id": 3, "passage_id": 2103}},
    {"id": 4504, "distance": 0.04037190228700638, "entity": {"doc_id": 4, "passage_id": 4504}},
    {"id": 592, "distance": 0.05172017961740494, "entity": {"doc_id": 2, "passage_id": 592}}
]
```

__Limitations__

- __Indexing Requirement__: This grouping feature works only for collections that are indexed with the __HNSW__ or __IVF-FLAT__ type. For more information, refer to [In-memory Index](https://milvus.io/docs/index.md#HNSW).

- __Performance Impact__: Be mindful that grouping based on a field with a limited range of unique values within a segment can slow down the process. This is because it involves scanning the entire segment for duplicate values.

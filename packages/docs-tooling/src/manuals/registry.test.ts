...
function manual(overrides: Partial<ManualDefinition> = {}): ManualDefinition {
  return {
    ...
    presentation: {
      ...
      sidebar: 'fixture',
      sidebarKey: 'fixtureSidebar',
      label: {en: 'Fixture', 'zh-CN': 'Fixture'},
      icon: 'fixture',
      href: '/reference/fixture',
      prefix: '/reference/fixture',
      groupOrder: 99,
      navOrder: {en: 99, 'zh-CN': 99},
      standalone: false,
      documentIdPrefix: 'fixture',
      landingPage: 'fixture/fixture.md',
...
describe('manual registry contract', () => {
  ...
  it('rejects retired paths that overlap any active publication target', () => {
    const retiring = manual({
      ...
      presentation: {
        referenceKind: 'retiring',
        sidebar: 'retiring',
        sidebarKey: 'retiringSidebar',
        label: {en: 'Retiring', 'zh-CN': 'Retiring'},
        icon: 'retiring',
        href: '/reference/retiring',
        prefix: '/reference/retiring',
        groupOrder: 98,
        navOrder: {en: 98, 'zh-CN': 98},
        standalone: false,
        documentIdPrefix: 'retiring',
        landingPage: 'retiring/retiring.md',
        minimumProseCharacters: 300,
        minimumHeadingCount: 2,
        requireSourceDifference: true,
      },
    ...
    const active = manual({
      ...
      presentation: {
        ...
        sidebar: 'active',
        sidebarKey: 'activeSidebar',
        label: {en: 'Active', 'zh-CN': 'Active'},
        icon: 'active',
        href: '/reference/active',
        prefix: '/reference/active',
        groupOrder: 97,
        navOrder: {en: 97, 'zh-CN': 97},
        standalone: false,
        documentIdPrefix: 'active',
        landingPage: 'active/active.md',
        minimumProseCharacters: 300,
        minimumHeadingCount: 2,
        requireSourceDifference: true,
      },

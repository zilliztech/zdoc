...
class larkDocWriter {
    ...
    async __mdx_patches(content) {
        // Delegate to the single canonical MDX patching pipeline in validate.cjs.
        // repairEndTagMismatch: true preserves the fetch-path behavior of repairing
        // mismatched closing tags; the translation path passes this option off and
        // instead reverts the file for retranslation.
        return applyMdxPatches(content, { repairEndTagMismatch: true });
    }

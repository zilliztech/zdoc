---
title: "Question Answering Using Zilliz Cloud and Cohere | BYOC"
slug: /question-answering-using-zilliz-cloud-and-cohere
sidebar_label: "With Cohere"
beta: FALSE
notebook: FALSE
description: "This page illustrates how to create a question-answering system based on the SQuAD dataset using Zilliz Cloud as the vector database and Cohere as the embedding system. | BYOC"
type: origin

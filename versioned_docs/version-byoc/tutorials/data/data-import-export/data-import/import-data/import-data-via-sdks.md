...
Once your data and collection are ready, you can import your data into a specific collection either via an external storage, such as an object storage bucket and a block storage blob container.

...
beta: FALSE
notebook: FALSE
description: "In Zilliz Cloud clusters, `VARCHAR` is the data type used for storing string data. When you define a `VARCHAR` field, two parameters are mandatory | BYOC"
type: origin

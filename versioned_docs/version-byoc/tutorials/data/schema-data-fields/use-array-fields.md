...
beta: FALSE
notebook: FALSE
description: "An ARRAY field stores an ordered set of elements of the same data type. Here's an example of how ARRAY fields store data | BYOC"
type: origin
...
<Tabs groupId="code" defaultValue='python' values={[{"label":"Python","value":"python"},{"label":"Java","value":"java"},{"label":"Go","value":"go"},{"label":"NodeJS","value":"javascript"},{"label":"cURL","value":"bash"},{"label":"HTTP","value":"http"}]}>
...
SERVER_ADDR = "http://10.102.6.75:19530"
...
rows.add(gson.fromJson("{\"tags\": None, \"ratings\": [4, 5], \"pk\": 2, \"embedding\": [0.4, 0.5, 0.6]}", JsonObject.class));

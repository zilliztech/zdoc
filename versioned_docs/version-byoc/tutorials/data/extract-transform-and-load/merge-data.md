...
![H5inwE7yXhwYkebNeuwcot6knTe](/img/H5inwE7yXhwYkebNeuwcot6knTe.png)

You can use the prepared **Parquet** file stored in an external object storage as the source data for the data merging operation. If this is the case, you may need to provide the access credentials for Zilliz Cloud to access to your S3-compatible object storage bucket.
...
Once you obtain the ID of the data merging job, you can use the [Describe Job](/reference/restful/describe-job-v2) or the steps listed in [Manage Project Jobs](./job-center) to check its status in detail.

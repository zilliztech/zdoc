---
title: "FAQ: Security | BYOC"
slug: /faq-security
sidebar_label: "FAQ: Security"
beta: FALSE
notebook: FALSE
description: "This topic covers potential issues related to data security on the Zilliz Cloud platform, including certificate authority, certificate validity period, procedures for checking certificate expiration, supported Transport Layer Security (TLS) versions, and authentication methods. | BYOC"
type: origin

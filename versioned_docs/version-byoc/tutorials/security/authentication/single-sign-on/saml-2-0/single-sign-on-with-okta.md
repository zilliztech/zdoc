...
1. In the **Configure SAML** step, you'll need to provide some information.

    - **Single Sign On URL**: **https://cloud.zilliz.com/sso/saml/acs** (For now, use a placeholder value. You'll update this later.)

    - **Audience Restriction**: Set the value to **zilliz**.
...
1. In the **Configure Single Sign-On (SSO)** step, enter the IdP settings using the credentials and certificate obtained from Okta in [Step 1](./single-sign-on-with-okta).

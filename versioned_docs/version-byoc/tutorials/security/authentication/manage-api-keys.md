...
![Ec7wwrAnFhGIZFbJTWwc57bVn0f](/byoc/Ec7wwrAnFhGIZFbJTWwc57bVn0f.png)
...
<table>
   ...
   <tr>
     ...
     <td><p>Full admin access to all resources within the organization, including projects and clusters.</p></td>
   </tr>
   <tr>
     <td colspan="2"><p>Organization Billing Admin</p></td>
     <td><p>Admin access to organization billing only. No access to projects and clusters within the organization.</p></td>
   </tr>
   <tr>
     <td rowspan="3"><p>Organization Member</p></td>
     <td><p>Project Admin</p></td>
     <td><p>Full admin access to specified projects and full admin access to all clusters within the projects by default.</p></td>
   </tr>
   <tr>
     <td><p>Project Read-Write</p></td>
     <td><p>Read and write access to specified projects as well as read and write access to all clusters within the projects by default.</p></td>
   </tr>
   <tr>
     <td><p>Project Read-Only</p></td>
     <td><p>Read-only access to specified projects as well as read-only access to all clusters within the projects by default.</p></td>
   </tr>
</table>
...
1. Navigate to the organization's **API Keys** page. Click **+ API Key**.
    ...
    ![KIOIbBjtfoz8oGxIyeJchda9nwe](/byoc/KIOIbBjtfoz8oGxIyeJchda9nwe.png)

1. Enter the **API Key Name** and configure the **API Key Access**.

    ![BSdPbaXHdoIPp0xBsA0chg0onfL](/byoc/BSdPbaXHdoIPp0xBsA0chg0onfL.png)

    - **API Key Name:** The name should not exceed 64 characters and can only contain alphanumerical characters, underscores, spaces or hyphens.

    - **API Key Access**: Define the access scope for the current customized API key by assigning the appropriate organization and project roles. For more fine-grained access control, you can limit the clusters that the key can access by checking **Restrict Access to Specific Clusters**.
...
Navigate to the organization's **API Keys** page. Your view may vary based on your specific [role](null).
...
![TmpIbZSs4oZSmdxST0Mcz90Qnqf](/byoc/TmpIbZSs4oZSmdxST0Mcz90Qnqf.png)
...
1. Navigate to the organization's **API Keys** page. Click **...** in the actions column and click **Edit**.
    ...
    ![X2aNbnJQcolWXix35WZcXNAtnVb](/byoc/X2aNbnJQcolWXix35WZcXNAtnVb.png)

1. Edit the API Key **API Key Name** and the **API Key Access**.

    ![A6XSbISD5oXgo2x2bwVc6ON9nJc](/byoc/A6XSbISD5oXgo2x2bwVc6ON9nJc.png)
...
- **Reset personal API keys**: you can reset your own personal API key only, regardless of your roles. 
    ...
    ![reset-personal-api-keys](/byoc/reset-personal-api-keys.png)

- **Reset customized API keys**: Only Organization Owners and Project Admins can reset customized API keys.

    ![reset-customized-api-keys](/byoc/reset-customized-api-keys.png)
...
![delte-customized-api-keys](/byoc/delte-customized-api-keys.png)

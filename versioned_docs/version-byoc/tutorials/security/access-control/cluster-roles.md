...
1. Navigate to the **Roles** tab of the target cluster. Click **+ Cluster Role**.
    ...
    ![add-cluster-role](/img/add-cluster-role.png "add-cluster-role")
...
1. Configure the privileges on the collection, database, and cluster level.  Select a built-in privilege group and then select the target resource. 
    ...
    ![add-cluster-role-form](/img/add-cluster-role-form.png "add-cluster-role-form")
...
![grant-role-to-user](/img/grant-role-to-user.png "grant-role-to-user")
...
![revoke-role-from-user](/img/revoke-role-from-user.png "revoke-role-from-user")
...
![edit-custom-role](/img/edit-custom-role.png "edit-custom-role")
...
![delete-cluster-role](/img/delete-cluster-role.png "delete-cluster-role")

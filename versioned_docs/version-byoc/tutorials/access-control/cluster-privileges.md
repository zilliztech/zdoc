...
The followings are all the privileges available on Zilliz Cloud. If you need to create your own privilege group with the privileges listed below, please [contact us](http://support.zilliz.com).

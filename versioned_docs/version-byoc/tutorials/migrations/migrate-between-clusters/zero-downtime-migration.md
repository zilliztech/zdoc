...
![PTB0wxmm2hCBc3b2dj1cCCJgnRb](/byoc/PTB0wxmm2hCBc3b2dj1cCCJgnRb.png)

<Admonition type="info" icon="📘" title="Notes">

<p>Zero Downtime Migration is in <strong>Public Preview</strong>. If you encounter any issues or want to learn about associated costs, contact <a href="https://zilliz.com/contact-sales">Zilliz Cloud support</a>.</p>
...
- Migration will fail if there are any ongoing import or bulk import jobs in the source cluster.

- This feature is available only for migration to new **Dedicated** clusters.

- Cancelling an ongoing Zero Downtime Migration job is not supported. This functionality will be available in future releases.

- Zero Downtime Migration requires approxiately 10 seconds of downtime for data sync to stop and the cluster transition to complete.
...
![zero-downtime-migration-1](/byoc/zero-downtime-migration-1.png)
...
1. In the dialog box that appears, configure migration settings:
    ...
    - **Source Cluster**: Choose the cluster from which you want to migrate. Ensure no bulk import jobs running on the source cluster.
...
![zero-downtime-migration-2](/byoc/zero-downtime-migration-2.png)
...
1. Click **Migrate**. Then, the migration job starts:
    ...
    - The source cluster will enter the **Locked** state. During this period, you cannot delete the source cluster or perform import/bulk import operations on the source cluster.
...
![zero-downtime-migration-3](/byoc/zero-downtime-migration-3.png)
...
![zero-downtime-migration-4](/byoc/zero-downtime-migration-4.png)

...
|                               |  100%             |  When CU capacity reaches 100%, you will be unable to write data into the cluster. Please [scale up](./manage-cluster#manage-and-configure-clusters) immediately to avoid service interruption.                  |

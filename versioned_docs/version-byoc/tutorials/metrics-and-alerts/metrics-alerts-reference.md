...
<table>
   ...
   <tr>
     ...
     <td><ul><li><p><strong>&gt;70%</strong>: assess future needs and plan renewal/upgrade.</p></li><li><p><strong>100%</strong>: renew/upgrade immediately to avoid disruption.</p></li></ul></td>
   </tr>
</table>
...
<p>In this section, <strong>Availability</strong> refers to the cluster’s plan tier. <strong>All</strong> means the metric is available across all current cluster plan tiers. For detailed plan tiers, refer to <a href="./select-zilliz-cloud-service-plans">Detailed Plan Comparison</a>.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Dedicated (Enterprise) / BYOC</p></td>
   </tr>
   <tr>

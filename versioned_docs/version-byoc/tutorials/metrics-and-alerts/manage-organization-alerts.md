...
<table>
   ...
   <tr>
     ...
     <td><p><strong>Below 70%</strong>: Continue monitoring to ensure core usage stays within this range. </p><p><strong>70-99%</strong>: Assess future needs and prepare to renew or upgrade the license.</p><p><strong>100% or above</strong>: Renew or upgrade the license immediately to avoid operational disruptions.</p><p>For details, refer to <a href="./license">License</a>.</p></td>
   ...
   <tr>
     ...
     <td><p><strong>Above 60 days</strong>: Continue monitoring to ensure more than 60 days of validity remain. </p><p><strong>60 days or below</strong>: Start preparing to renew or upgrade the license. </p><p><strong>Expired</strong>: Renew or upgrade the license immediately to avoid restrictions like the inability to create new clusters or scale up.</p><p>For details, refer to <a href="./license">License</a>.</p></td>

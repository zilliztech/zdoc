...
- Subscribe directly on the [AWS](./undefined) or [GCP](./undefined) Marketplace.
...
- Unsubscribe manually from the original [AWS](./undefined#cancel-aws-marketplace-subscription) or [GCP](./undefined#cancel-gcp-marketplace-subscription) Marketplace.

- [Add your credit card](./undefined) on the Zilliz Cloud web console.

### Between Marketplace subscriptions{#between-marketplace-subscriptions}

- Unsubscribe from the current Marketplace.

- Resubscribe using the new [AWS](./undefined) or [GCP](./undefined) Marketplace account.

---
title: "Use JSON Fields | BYOC"
slug: /use-json-fields
sidebar_label: "Use JSON Fields"
beta: FALSE
notebook: FALSE
description: "This guide explains how to use the JSON fields, such as inserting JSON values as well as searching and querying in JSON fields with basic and advanced operators. | BYOC"
type: origin
...
<li><p>Use only alphanumeric characters and underscores to name JSON keys, as other characters may cause problems with scalar-filtering and searches.</p></li>
</ul>
...
After creating a collection, you can insert dictionaries such as the one demonstrated in [Overview](./use-json-fields#overview).

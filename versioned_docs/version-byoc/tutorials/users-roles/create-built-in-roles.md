...
- If you encounter an error while using the built-in roles feature with a cluster, please [contact us](https://zilliz.com/contact-sales) for troubleshooting assistance.

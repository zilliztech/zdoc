...
|  **Resource Type**          |  **Instance**<br/> <br/>   |  Min. Config<br/> <br/>                                                                                                                                  |
| --------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
|  Virtual Machine<br/> <br/>   |  EC2<br/> <br/>            |  - (m6i.xlarge) * 4<br/> <br/>  - (m6i.2xlarge) * 4<br/> <br/>  - (m6i.8xlarge) * 1<br/> <br/>  - (m6id.8xlarge) * 1<br/> <br/>  **Total**: 112 vCPUs, 448 GiB |
|  Object Storage             |  S3                      |  2 buckets                                                                                                                                             |
|  Block Storage              |  EBS                     |  1 TB +                                                                                                                                                |
|  Public IP                  |  EIP                     |  1                                                                                                                                                     |
|  Private Network            |  VPC<br/> <br/>            |  1                                                                                                                                                     |
|  Network Channel            |  PrivateLink             |  2                                                                                                                                                     |
|  K8s Cluster                |  EKS                     |  1                                                                                                                                                     |
|  DNS                        |  DNS Zone                |  1                                                                                                                                                     |
...
|  **aws_iam_role_policy_attachment.bootstrap_attachment**<br/> <br/>   |  **zilliz-bootstrap-role**             |  Attaches a specific policy to the role **zilliz-bootstrap-role**, enabling the assignment of predefined permissions to this role.                                                                                                 |

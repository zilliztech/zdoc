...
Once the status tag on a project card reads **Running**, you can start creating clusters in the project. For a running project, you can perform the following operations: 

- **Rename** / **Delete**

    To rename or delete a running project, ensure that there are no clusters in the project.

- **Suspend**

    You can suspend a running project only if there is no cluster in the project or all clusters in the project have already been suspended.

### Projects with a Suspended tag{#projects-with-a-suspended-tag}

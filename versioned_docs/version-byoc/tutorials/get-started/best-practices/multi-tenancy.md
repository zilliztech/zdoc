...
## Multi-tenancy strategies in Zilliz Cloud{#multi-tenancy-strategies-in-zilliz-cloud}
...
- **Scalability**: A collection can hold up to 1,024 partitions, allowing for the same number of tenants within it.
...
<table>
   ...
   <tr>
     ...
     <td><p>1024</p></td>
     <td><p>Up to 16,384 depending on the cluster plan.  See <a href="./limits#collections">Zilliz Cloud Limits</a></p></td>
     <td><p>Up to 1,024 per collection depending on the cluster plan.  See <a href="./limits">Zilliz Cloud Limits</a></p></td>
     <td><p>Millions</p></td>
   </tr>
   <tr>

---
title: "User Roles | BYOC"
slug: /user-roles
sidebar_label: "User Roles"
beta: FALSE
notebook: FALSE
description: "In Zilliz Cloud, Role-based Access Control (RBAC) is pivotal for delineating permissions across organizations, projects, and clusters. This system allows organization and project owners to efficiently manage user roles and access, maintaining streamlined operations and security. | BYOC"
type: origin
...
<p></p>
<ul>
<li>If you encounter an error while using the built-in roles feature with a cluster, please <a href="https://zilliz.com/contact-sales">contact us</a> for troubleshooting assistance.</li>
</ul>

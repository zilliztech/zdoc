...
slug: /python/python/CrossEncoder-__call__
beta: FALSE
notebook: FALSE
type: docx
...
This operation in [CrossEncoderRerankFunction](./CrossEncoder-CrossEncoderRerankFunction) takes in a query and document strings and returns a list of `RerankResult` objects with the top k documents ranked by score.

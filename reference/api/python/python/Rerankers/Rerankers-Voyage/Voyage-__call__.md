...
slug: /python/python/Voyage-__call__
beta: FALSE
notebook: FALSE
type: docx
...
This operation in [VoyageRerankFunction](./Voyage-VoyageRerankFunction) takes in a query and document strings and returns a list of `RerankResult` objects with the top k documents ranked by score.

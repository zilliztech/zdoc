...
slug: /python/python/BGE-__call__
beta: FALSE
notebook: FALSE
type: docx
...
This operation in [BGERerankFunction](./BGE-BGERerankFunction) takes in a query and document strings and returns a list of `RerankResult` objects with the top k documents ranked by score.

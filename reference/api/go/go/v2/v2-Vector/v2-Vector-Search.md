...
### NewSearchOption\{#newsearchoption}
...
### Search with JSON expressions\{#search-with-json-expressions}
...
### Search with multiple vectors\{#search-with-multiple-vectors}
...
### Search with offset and limit\{#search-with-offset-and-limit}
...
### Search within partitions\{#search-within-partitions}

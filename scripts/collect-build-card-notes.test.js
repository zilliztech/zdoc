...
test('assembly reporting renders bounded regeneration reasons and rejects false reuse results', () => {
  withTempCwd(() => {
    ...
    assert.match(assemblyIdentityNote(), /Regenerated: source-delta/)
    ...
    assert.doesNotMatch(assemblyIdentityNote(), /Sidebar reused|regenerated bytes matched baseline/)
  })
})

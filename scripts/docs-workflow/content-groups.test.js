...
test('derives preservation metadata without a legacy path map', () => {
  assert.deepEqual(getContentGroup('java').preservedPaths, ['content/en/reference/api/java/java/v2/java.md']);
  assert.deepEqual(getContentGroup('go').preservedPaths, ['content/en/reference/api/go/go/v2/go.md']);
});

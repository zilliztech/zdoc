...
function validateToolingSelection(value, helpers) {
  ...
  if (value.inputs.selectedGroup !== 'all') helpers.invalid(document, 'selectedGroup must be all')
...
function validateToolingReady(value, {selection}, helpers) {
  ...
  if (value.unitKey !== 'tooling/master') helpers.invalid(document, 'unitKey must be tooling/master')

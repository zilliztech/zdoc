...
function stagePaths(site = 'en') {
  ...
  source: [
    ...
    'packages/docs-tooling/src/lark/meta/reports/guides-requested-fetch-plan.json',
    'packages/docs-tooling/src/lark/meta/reports/guides-requested-fetch-plan.md',
    'packages/docs-tooling/src/lark/meta/reports/guides-requested-fetch-plan-selection.json',
    'packages/docs-tooling/src/lark/meta/reports/guides-requested-fetch-plan-state-merge.json',
    'packages/docs-tooling/src/lark/meta/reports/guides-requested-fetch-plan-revalidation.json',

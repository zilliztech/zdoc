...
1. Use `git diff v2.22.0 v2.21.0 -- docs/tutorials/**/*.md` to find the changes made to the source documents since the last translation.
2. Use the identified changes as a reference to update the corresponding translated documents in the Target folders.
3. Commit the changes to the Target folders.
...
2. Use `git diff v2.22.0 v2.21.0 -- docs/tutorials/**/*.md` to find the changes made to the source documents since the last translation. 

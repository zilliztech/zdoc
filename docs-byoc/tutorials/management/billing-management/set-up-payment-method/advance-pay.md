...
notebook: FALSE
description: "Zilliz Cloud accepts advance pay (bank transfer) as the payment method in alternative to adding a credit card or subscribing on AWS Marketplace. | BYOC"
type: origin

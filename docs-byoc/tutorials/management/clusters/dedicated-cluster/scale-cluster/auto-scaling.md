...
notebook: FALSE
description: "Auto-scaling automatically adjusts a Dedicated serving cluster within the minimum and maximum limits that you configure. It helps protect query performance during workload spikes and reduce resource usage when traffic decreases. | BYOC"
type: origin

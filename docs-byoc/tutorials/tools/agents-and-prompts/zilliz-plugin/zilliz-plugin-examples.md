---
title: "Zilliz Claude Code Plugin Examples | BYOC"
...
notebook: FALSE
description: "In this guide, you will find more examples that use natural language to provision infrastructure, perform data operations, back up and restore your data across clusters, and implement access control for the sake of cluster security. | BYOC"
type: origin

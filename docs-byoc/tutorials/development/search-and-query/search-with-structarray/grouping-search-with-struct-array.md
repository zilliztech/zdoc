---
title: "Grouping Search with StructArray | BYOC"
...
notebook: FALSE
description: "Use this page to group StructArray element-level search results by the parent entity. Element-level search can return multiple hits from the same entity when several Struct elements match the query. Grouping collapses those element hits so each parent entity appears at most once. | BYOC"
type: origin

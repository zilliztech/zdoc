---
title: "Index StructArray Fields | BYOC"
...
notebook: FALSE
description: "Create indexes on StructArray subfields before you run vector search or accelerate scalar filtering. For a StructArray field, the index target is a subfield path, such as `chunks[emblistvector]`, `chunks[emb]`, or `chunks[section]`. | BYOC"
type: origin

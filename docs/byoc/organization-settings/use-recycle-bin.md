...
slug: /docs/byoc/use-recycle-bin
beta: FALSE
notebook: FALSE
sidebar_position: 4
---
...
To restore a database in the recycle bin, you need to add a payment method. 
...
1. Configure the restored cluster.
    1. You can restore the database to a different project under this organization, but not in a different cloud region.
...
1. Click **Restore**. Zilliz Cloud will start creating the cluster with the specified attributes and restore your data to the created database.

<Admonition type="info" icon="📘" title="Notes">

During restoration, the status of your database will change from **CREATING** to **RESTORING** and finally **RUNNING**. When the cluster is running, all your deleted data are restored.

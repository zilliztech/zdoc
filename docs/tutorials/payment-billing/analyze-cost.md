...
- [Via RESTful API](./analyze-cost#via-restful-api-public-preview): If you need more detailed insights into the daily usage, we recommend using the RESTful API. Usage details obtained from the RESTful API are precise to **8 decimal places** (Eg. $60.00257846).
...
### Via RESTful API Public Preview{#via-restful-api-public-preview}

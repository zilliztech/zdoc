---
title: "Separate Zilliz Cloud Billing on Azure Marketplace | Cloud"
slug: /separate-zilliz-cloud-billing-on-azure-marketplace
sidebar_key: separate-zilliz-cloud-billing-on-azure-marketplace
sidebar_label: "Separate Billing on Azure"
added_since: FALSE
last_modified: FALSE
deprecate_since: FALSE
beta: FALSE
notebook: FALSE
description: "If you need to separate Zilliz Cloud billing on Azure Marketplace by business unit, team, use case, application, or cost center, the recommended pattern is to use one Azure subcription, one Azure Marketplace subscription and one Zilliz Cloud organization per business unit. | Cloud"
type: origin
...
# Separate Zilliz Cloud Billing on Azure Marketplace

If you need to separate Zilliz Cloud billing on [Azure Marketplace](https://marketplace.microsoft.com/en-us/) by business unit, team, use case, application, or cost center, the recommended pattern is to use one Azure subcription, one Azure Marketplace subscription and one Zilliz Cloud organization per business unit.

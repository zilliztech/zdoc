...
- **Audit Logs CU Unit Price**: Determined by the cloud region and the plan of the cluster. For detailed rates, refer to [Zilliz Cloud Pricing Guide](https://zilliz.com/pricing/pricing-guide).
...
With the plan and cloud provider and region information, you can find on the [pricing guide page](https://zilliz.com/pricing/pricing-guide) that the audit logs unit price is **&#36;0.031/hour**.

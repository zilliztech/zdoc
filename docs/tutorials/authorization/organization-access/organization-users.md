---
title: "Organization Users | Cloud"
slug: /organization-users
sidebar_label: "Organization Users"
beta: FALSE
notebook: FALSE
description: "In Zilliz Cloud, you can invite users to join organizations and provide them with access to organizations by assigning them specific roles, each with different permission levels. | Cloud"
type: origin

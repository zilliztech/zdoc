...
1. Navigate to the organization's **API Keys** page. Click **+ API Key**.
    ...
    ![KIOIbBjtfoz8oGxIyeJchda9nwe](/img/KIOIbBjtfoz8oGxIyeJchda9nwe.png)
...
![TmpIbZSs4oZSmdxST0Mcz90Qnqf](/img/TmpIbZSs4oZSmdxST0Mcz90Qnqf.png)
...
1. Navigate to the organization's **API Keys** page. Click **...** in the actions column and click **Edit**.
    ...
    ![X2aNbnJQcolWXix35WZcXNAtnVb](/img/X2aNbnJQcolWXix35WZcXNAtnVb.png)

1. Edit the API Key **API Key Name** and the **API Key Access**.

    ![A6XSbISD5oXgo2x2bwVc6ON9nJc](/img/A6XSbISD5oXgo2x2bwVc6ON9nJc.png)
...
![delte-customized-api-keys](/img/delte-customized-api-keys.png)

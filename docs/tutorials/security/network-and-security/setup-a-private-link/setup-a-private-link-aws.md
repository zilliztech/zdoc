...
- **Via UI console**
    ...
    ![AJlTbcoxNoXKBIxAxz6cYrkBnrc](/img/ajltbcoxnoxkbixaxz6cyrkbnrc.png "AJlTbcoxNoXKBIxAxz6cYrkBnrc")
    ...
    1. On the **Create Endpoint** page, select **Endpoint services that use NLBs and GWLBs** as the endpoint **Type**.
        ...
        ![create_endpoint_type_gcp](/img/create_endpoint_type_gcp.png "create_endpoint_type_gcp")
...
- **Via CLI**
    ...
    ![TzQdb9ReToZlkTxGRVZcCdUbnOe](/img/tzqdb9retozlktxgrvzccdubnoe.png "TzQdb9ReToZlkTxGRVZcCdUbnOe")
    ...
    1. Click the copy icon in the code block and go to the AWS console.
        ...
        ![setup_private_link_aws_cloud_shell](/img/setup_private_link_aws_cloud_shell.png "setup_private_link_aws_cloud_shell")
...
![setup_private_link_aws_authorize_endpoint](/img/setup_private_link_aws_authorize_endpoint.png "setup_private_link_aws_authorize_endpoint")
...
- **Create a hosted zone using Amazon Route 53**
    ...
    ![A1zxblLRPo96Kvx0zzccZ485nGb](/img/a1zxbllrpo96kvx0zzccz485ngb.png "A1zxblLRPo96Kvx0zzccZ485nGb")
...
- **Create an alias record in the hosted zone**
    ...
    ![VoCsbJtTDo1glVx0vtGcqWPRnEd](/img/vocsbjttdo1glvx0vtgcqwprned.png "VoCsbJtTDo1glVx0vtGcqWPRnEd")
...
- No private DNS records exist.
    ...
    ![QOanbDGrYovMXHxczXmcCbUcnsc](/img/qoanbdgryovmxhxczxmccbucnsc.png "QOanbDGrYovMXHxczXmcCbUcnsc")
    ...
    ![X5ahblpw1oRxp8xKR3OczuD9nFf](/img/x5ahblpw1orxp8xkr3oczud9nff.png "X5ahblpw1oRxp8xKR3OczuD9nFf")
...
- No or invalid security group rules exist.
    ...
    ![ERtlbR2v7oA3Q4xXRlccM3VhnNc](/img/ertlbr2v7oa3q4xxrlccm3vhnnc.png "ERtlbR2v7oA3Q4xXRlccM3VhnNc")
    ...
    ![KHj0bEy7ZojM6axnR0ocg1LPnue](/img/khj0bey7zojm6axnr0ocg1lpnue.png "KHj0bEy7ZojM6axnR0ocg1LPnue")

...
This topic describes how to delete a Zilliz Cloud account. Once the account is deleted, you cannot use it to log in to or sign up with Zilliz Cloud again.

## Before you start{#before-you-start}

Make sure the following conditions are met:

- If you are the only project owner in a project with clusters, [delete the project clusters](./manage-cluster#drop-cluster).
...
1. Complete the feedback form and click the button to submit feedback and delete the account.

1. You will receive an email notification when your account is successfully deleted.

:::caution Warning

The action of deleting an account cannot be undone. Please take extra caution with this action.

...
Snapshots are supported only for the **Standard** and **Enterprise** tiers. If your cluster runs on the **Serverless** tier, upgrade it first. For more information on cluster types, see [Cluster Types Explained](./cluster-types-explained).

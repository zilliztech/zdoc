...
Zilliz Cloud offers three subscription plans: **Starter**, **Standard**, and **Enterprise**.

- The **Starter** plan provides a serverless cluster available on GCP, the simplest way to experience a fully-managed vector database. This tier is suitable for for hobbyists or developers who want to experiment with Zilliz Cloud. No credit card is required, and minimal configuration is needed.

- The **Standard** plan is designed for small or mid-sized teams with less complex workloads. This option offers a dedicated cluster available on both AWS and GCP, perfect for users who need a cost-efficient solution to process large-scale data with dedicated clusters.

- The **Enterprise** plan is for at-scale organizations that require dedicated clusters with advanced features, high availability and security, and 24/7/365 support. It is available on both AWS and GCP.

Both the **Starter** and **Standard** plans come with a free trial.

## Starter plan free trial{#starter-plan-free-trial}
...
## Compare free trial plans{#compare-free-trial-plans}

|  **Item**               |  **Starter** |  **Standard**                |
| ----------------------- | ------------ | ---------------------------- |
|  Cluster type           |  Serverless  |  Dedicated                   |
|  Charge                 |  Free        |  Deducted from free credits  |
|  Duration of free trial |  Permanent   |  30 days                     |
|  Scenario               |  Quick start |  PoC                         |

...
Connectors makes it easy to integrate various data sources into your Zilliz Cloud Pipelines. This guide walks you through the simple  process of setting up connectors on the Zilliz Cloud web UI.

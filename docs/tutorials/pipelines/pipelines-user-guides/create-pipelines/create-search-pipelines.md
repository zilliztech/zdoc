...
1. Add a function to the Search pipeline. You can add exactly one __SEARCH_DOC_CHUNK__ function.
    ...
    <p>For convenience, the web UI forces the input field name to be <code>query_text</code>. To customize it, you can <a href="./create-search-pipelines#via-restful-api">create a Search pipeline via RESTful API</a>.</p>

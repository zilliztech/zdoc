...
|  **Pipeline Type**  |  **Maximum Number (Per Project)** |
| ------------------- | --------------------------------- |
...
|  openai/text-embedding-3-small |  20-8,191                      |
|  openai/text-embedding-3-large |  20-8,191                      |
...
The following table lists the limits on the number of tokens that are allowed to be ingested each time.

|  **Embedding Model**           |  **max_total_tokens/ingestion** |
| ------------------------------ | ------------------------------- |
|  zilliz/bge-base-en-v1.5       |  280,000                        |
|  voyageai/voyage-2             |  240,000                        |
|  voyageai/voyage-code-2        |  90,000                         |
|  openai/text-embedding-3-small |  5,000,000                      |
|  openai/text-embedding-large   |  760,000                        |
|  zilliz/bge-base-zh-v1.5       |  280,000                        |
...
|  **Cluster Type**                                    |  **Max Number**                              |  **Remarks**                                                                                                               |
| ---------------------------------------------------- | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
|  Serverless cluster |  2<br/>  |  You can create up to 2 serverless clusters.                                              |

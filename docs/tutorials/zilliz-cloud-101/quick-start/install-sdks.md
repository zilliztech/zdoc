...
The [Quick Start](./quick-start-1) and [Starter User Guides](https://docs.zilliz.com/docs/starter-user-guides) use examples that demonstrate the starter APIs. On the other hand, the advanced APIs are used in the [Use Customized Schema](./use-customized-schema), [Enable Dynamic Schema](./enable-dynamic-schema), [JavaScript Object Notation (JSON)](./javascript-object-notation-json-1), and [Use Partition Key](./use-partition-key) sections.
...
- Upgrade PyMilvus to the lastest version.

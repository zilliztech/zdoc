---
title: "Question Answering Using Zilliz Cloud and HuggingFace | Cloud"
slug: /question-answering-using-zilliz-cloud-and-hugging-face
sidebar_label: "With HuggingFace"
beta: FALSE
notebook: FALSE
description: "This page illustrates how to build a question-answering system using Zilliz Cloud as the vector database and Hugging Face as the embedding system. | Cloud"
type: origin

---
title: "Similarity Search with Zilliz Cloud and OpenAI | Cloud"
slug: /similarity-search-with-zilliz-cloud-and-openai
sidebar_label: "With OpenAI"
beta: FALSE
notebook: FALSE
description: "This page discusses integrating vector databases with OpenAI's embedding API. | Cloud"
type: origin

...
- **Pre-search Functions**
    ...
    For a conceptual overview of how Pre-search Functions work, see [Function & Model Inference Overview](./undefined).
...
- **Post-search Functions**
    ...
    For a conceptual overview of how Post-search Functions work, see [Function & Model Inference Overview](./undefined).

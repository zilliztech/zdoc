...
{/* Temporarily hidden — keep the banner (logic unchanged) for later:
<FeatureNote variant="region" icon="flag" title="Plan & region availability" titleHref="/docs/pricing">
- On-demand search is generally available on the Standard and Enterprise plans. Project endpoints require a **Serverless** or **Dedicated** cluster in the same region.
- Currently supported in AWS us-west-2, AWS us-east-1, and GCP us-central1; additional regions are rolling out.
</FeatureNote>
*/}

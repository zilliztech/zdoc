---
title: "Hybrid Search with StructArray | Cloud"
...
notebook: FALSE
description: "Use this page to combine StructArray vector search with other vector searches in one hybrid search request. StructArray hybrid search can produce either entity-level results or element-level results, depending on the `AnnSearchRequest` objects you combine. | Cloud"
type: origin

...
notebook: FALSE
description: "The Array of Structs, or StructArray, stores an ordered set of Struct elements in each entity. Each Struct in the array shares the same predefined schema, which can include scalar sub-fields and vector sub-fields. | Cloud"
type: origin

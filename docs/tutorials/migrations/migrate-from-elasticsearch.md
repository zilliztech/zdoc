...
- You have created a **Dedicated** cluster on Zilliz Cloud. For details, see [Create Cluster](./undefined) and [Select the Right Cluster Plan](./select-zilliz-cloud-service-plans).

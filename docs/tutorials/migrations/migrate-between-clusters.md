...
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud allows you to seamlessly transfer data from a serverless cluster to a dedicated cluster or between two Dedicated clusters. | Cloud"
type: origin

---
title: "Update Payment Method | Cloud"
...
### Upgrade AWS Marketplace free trial\{#upgrade-aws-marketplace-free-trial}

If you are using an AWS Marketplace free trial, you can upgrade to a paid AWS Marketplace subscription. For details, see [Upgrade to paid subscription](./subscribe-on-aws-marketplace-free-trial#upgrade-to-paid-subscription).

After the upgrade is complete, verify the update in Zilliz Cloud. Go to the **Billing Overview** page and check the **Payment Method** section.

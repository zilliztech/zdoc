---
title: "Slow Logs Reference | Cloud"
...
notebook: FALSE
description: "Slow logs are delivered in JSON Lines format - one JSON object per line. Each line is a self-contained JSON object representing a single operation. The following example shows a representative slow log entry for a search request | Cloud"
type: origin

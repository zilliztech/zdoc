...
The schema of the collection to be created is similar to the one specified in [Use Customized Schema](./use-customized-schema) except for the settings of the `publication` field.
...
Once you have indexed and loaded the collection as well as inserted data as described in [Use Customized Schema](./use-customized-schema), you can conduct an ANN search using the partition key. 

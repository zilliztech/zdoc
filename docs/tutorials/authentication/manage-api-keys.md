...
To ensure security, only users with [Owner](./undefined) status, either at the organization or project level, are allowed to create and oversee these API keys. For more information, see [Users & Roles](./undefined).

This topic describes how to create and manage API keys.

## Create an API key{#create-an-api-key}

To create an API key, you must be an [Organization Owner](./undefined#organization-roles) or a [Project Owner](./undefined#project-roles).

![create-api-key](/img/create-api-key.png)

## View API keys{#view-api-keys}

To view API keys created for a project, you must be an [Organization Owner](./undefined#organization-roles) or a [Project Owner](./undefined#project-roles).
...
To delete an API key, you must be an [Organization Owner](./undefined#organization-roles) or a [Project Owner](./undefined#project-roles).

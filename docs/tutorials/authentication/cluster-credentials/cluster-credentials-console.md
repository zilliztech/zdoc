---
title: "Manage Cluster Credentials (Console) | Cloud"
slug: /cluster-credentials-console
sidebar_label: "Manage Cluster Credentials (Console)"
beta: FALSE
notebook: FALSE
description: "In Zilliz Cloud, a cluster credential consists of a username and password pair, utilized to authenticate and authorize your requests for cluster interaction. | Cloud"
type: origin

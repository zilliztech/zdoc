...
### Can I enable dynamic schema functionality by adding a `#meta` field?{#can-i-enable-dynamic-schema-functionality-by-adding-a-meta-field}
...
For an existing collection, you still need to create a new collection with the dynamic field enabled and migrate the data to the new collection.

...
Once your cluster is operational, connect to it utilizing its public endpoint and an authentication token. This token can be  an [API key](./manage-api-keys) or a [cluster credential](null) that consists of a username and password pair.

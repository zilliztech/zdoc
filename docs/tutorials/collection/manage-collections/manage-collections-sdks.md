---
title: "Manage Collections (SDKs) | Cloud"
slug: /manage-collections-sdks
sidebar_label: "SDKs"
beta: FALSE
notebook: FALSE
description: "This guide walks you through creating and managing collections using the SDK of your choice, which is more flexible and customizable when compared with the operations on the intuitive Web UI of the Zilliz Cloud console. | Cloud"
type: origin

...
- __Customized setup__
    ...
    Instead of letting Zilliz Cloud decide almost everything for your collection, you can determine the __schema__ and __index parameters__ of the collection on your own. For details, refer to [Customized setup](./manage-collections-sdks#customized-setup).
...
Instead of letting Zilliz Cloud decide almost everything for your collection, you can determine the __schema__ and __index parameters__ of the collection on your own.

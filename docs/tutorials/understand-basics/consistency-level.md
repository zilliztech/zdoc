...
beta: FALSE
notebook: FALSE
description: "In distributed databases, consistency ensures that every node or replica offers the same data view during read or write operations. Zilliz Cloud provides three consistency levels Strong, Bounded Staleness, and Eventually, with Bounded Staleness set as the default. | Cloud"
type: origin

...
For details on feature availabilities, refer to [Current Feature Availability](./undefined#current-feature-availability).
...
For details, refer to [Cluster Auto-scaling](./undefined).
...
For details on JSON path indexes, refer to [Index Values Inside a JSON Field](./undefined) and [Index Keys in the Dynamic Field](./enable-dynamic-field#index-keys-in-the-dynamic-field).

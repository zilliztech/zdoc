...
<Grid columnSize="2" widthRatios="24,75">
    ...
    <div>
        ...
        - **Partial upserts** — Update specific fields without rewriting entire records. For details, refer to [Upsert Entities](./upsert-entities#upsert-entities-in-merge-mode).

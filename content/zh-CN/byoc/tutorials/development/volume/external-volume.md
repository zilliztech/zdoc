...
notebook: FALSE
description: "External Volume 映射至您自有云服务对象存储（如阿里云 OSS 或亚马逊云科技 S3）中某个存储桶。通过 External Volume，Zilliz Cloud 可访问您的数据，您无需将数据复制或迁移到 Zilliz Cloud。 | BYOC"
type: origin

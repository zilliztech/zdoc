---
title: "修改外部 Collection Schema | BYOC"
...
notebook: FALSE
description: "创建外部 Collection 后，外部数据源通常还会继续演进。例如，已经存储 Embedding 的 Lakehouse 表之后可能会新增 score、category 或 timestamp 等标量字段，而你可能希望在查询结果中返回这些字段，或在过滤表达式中使用它们。 | BYOC"
type: origin

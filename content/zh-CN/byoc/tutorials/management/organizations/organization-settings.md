...
要编辑组织名称，您必须是[组织管理员](./manage-platform-roles#manage-organization-roles)。
...
如需查看时区，您的角色可以是组织管理员或组织成员。更多有关组织角色详情，请参考[管理平台角色](./manage-platform-roles#manage-organization-roles)。

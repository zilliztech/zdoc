...
notebook: FALSE
description: "Zilliz Cloud 使用身份来表示可访问组织、项目、集群、API 或 SDK 工作流的人员。身份管理控制哪些身份存在于 Zilliz Cloud 中，以及这些身份如何被邀请、同步、创建、移除或认证。随后，访问控制决定这些身份可以访问什么，以及可以执行哪些操作。 | Cloud"
type: origin
...
Zilliz Cloud 使用身份来表示可访问组织、项目、集群、API 或 SDK 工作流的人员。身份管理控制哪些身份存在于 Zilliz Cloud 中，以及这些身份如何被邀请、同步、创建、移除或认证。随后，[访问控制](./access-control-overview)决定这些身份可以访问什么，以及可以执行哪些操作。

...
通过这些增强，您可以轻易地将您存储在其它厂商的数据快速迁移到 Zilliz Cloud，从而利用 Zilliz Cloud 独有的功能和能力。关于具体的迁移流程，可以参考 [从 Qdrant 迁移至 Zilliz Cloud](./migrate-from-qdrant)和 [从腾讯云 VectorDB 迁移至 Zilliz Cloud](./migrate-from-tencent-cloud)。

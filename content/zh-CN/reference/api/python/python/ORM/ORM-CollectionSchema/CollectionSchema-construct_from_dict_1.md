...
notebook: false
description: "此操作从字典表示中构造一个 CollectionSchema 对象。 | Python | ORM"
type: docx
...
此操作从字典表示中构造一个 **[CollectionSchema](./MilvusClient-CollectionSchema)** 对象。
...
- **raw** (*dict*)
    ...
    一个字典，包含用于构造 Collection Schema 的原始数据。

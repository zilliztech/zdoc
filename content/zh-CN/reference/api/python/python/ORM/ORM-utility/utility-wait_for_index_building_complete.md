...
notebook: false
description: "此操作会阻塞当前进程，直到指定索引构建完成。 | Python | ORM"
type: docx
...
- **collection_name** (*str*) -
    ...
    **[必需]**
    ...
    如果将其设置为不存在的 Collection，则会导致 **CollectionNotExistException**。
...
- **index_name** (*str*) -
    ...
    如果将其设置为不存在的索引，则会导致 **IndexNotExistException**。

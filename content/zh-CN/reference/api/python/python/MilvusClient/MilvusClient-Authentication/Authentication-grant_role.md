...
notebook: false
description: "此操作会向用户授予角色。 | Python | MilvusClient"
type: docx
...
每个 Zilliz Cloud 集群都有三个内置角色，即 **db\_ro**、**db\_rw** 和 **db\_admin**。有关详情，请参见 [集群内置角色](/docs/cluster-roles#built-in-cluster-roles)。

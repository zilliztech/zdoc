...
notebook: false
description: "此操作会向特定 Collection 中插入数据。 | Python | MilvusClient"
type: docx
...
- **data** (*dict* | *list[dict]*) -
    ...
    **[必需]**
    ...
    以下代码假设当前 Collection 的 Schema 包含两个名为 **id** 和 **vector** 的字段。前者是主字段，后者是用于保存 5 维向量嵌入的字段。

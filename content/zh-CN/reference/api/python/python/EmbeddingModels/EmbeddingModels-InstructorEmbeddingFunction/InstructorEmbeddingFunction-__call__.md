...
notebook: false
description: "InstructorEmbeddingFunction 中的此操作接受一个文本字符串列表，并将其直接编码为向量嵌入。 | Python"
type: docx
...
[InstructorEmbeddingFunction](./EmbeddingModels-InstructorEmbeddingFunction) 中的此操作接受一个文本字符串列表，并将其直接编码为向量嵌入。

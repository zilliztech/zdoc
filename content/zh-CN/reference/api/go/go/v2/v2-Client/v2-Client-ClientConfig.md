...
notebook: false
description: "配置 Milvus v3 客户端连接，包括身份验证、TLS、重试、遥测、Database 和 gRPC authority 设置。 | Go | v2"
type: docx
...
配置 Milvus v3 客户端连接，包括身份验证、TLS、重试、遥测、Database 和 gRPC authority 设置。
...
用于创建 Milvus 客户端的配置，包括地址、身份验证、TLS、Database 和 gRPC 选项。

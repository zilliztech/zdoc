---
title: "Connect to Clusters | BYOC"
...
notebook: FALSE
description: "Use a Dedicated cluster endpoint when your application needs the full Collection API, including schema management, insert, upsert, delete, search, query, and hybrid search. | BYOC"
type: origin
...
- You have completed the network configurations between your application and the clusters in the BYOC project. For details, refer to [Prepare for Cluster Connection](./prepare-for-cluster-connection).

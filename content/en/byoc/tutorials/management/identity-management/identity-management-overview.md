---
title: "Identity Management Overview | BYOC"
...
notebook: FALSE
description: "Zilliz Cloud uses identities to represent the people, groups that can access an organization, project, cluster, API, or SDK workflow. Identity management controls who exists in Zilliz Cloud and how those identities are invited, synchronized, created, removed, or authenticated. Access control then determines what those identities can access and what actions they can perform. | BYOC"
type: origin
...
| Project member | Project | Access to a specific project and its project-level resources. |
...
| Project member | Whether a user or group can access a specific project. | Project access must be granted for a specific project. Cross-project wildcard authorization is not supported. |

---
title: "Connect for On-Demand Search | BYOC"
...
notebook: FALSE
description: "Use a project endpoint when you want to run on-demand search or query workloads with compute from an on-demand cluster. | BYOC"
type: origin

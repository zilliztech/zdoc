...
notebook: FALSE
description: "A database is a logical container for collections within a project. It helps you organize data for different applications, tenants, or environments while keeping collection names and operations scoped to the database you choose. | BYOC"
type: origin

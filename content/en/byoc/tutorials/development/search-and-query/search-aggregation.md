...
notebook: FALSE
description: "When a shopper searches for \"black running shoes for daily training,\" approximate nearest neighbor (ANN) search ranks products by vector similarity and returns a flat Top-K list. The results can be relevant but repetitive in the example below, four of the first six results are Brand A products, while Brand B and Brand C appear once each. | BYOC"
type: origin

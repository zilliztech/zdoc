---
title: "Integrate with AWS S3 | BYOC"
...
notebook: FALSE
description: "Zilliz Cloud allows you to integrate with Amazon Simple Storage Service (Amazon S3) to export audit logs to designated S3 buckets. | BYOC"
type: origin
...
1. In the dialog box that appears, configure **Basic Settings**:
    ...
    - **Bucket Permission**: Select the level of access Zilliz Cloud has to your S3 bucket. The following table explains the options.
        ...
        | Read write | Zilliz Cloud can both read from and write to the bucket. Use for [audit log forwarding](./audit-logs), or [access log forwarding](./configure-access-logs). |
...
To give Zilliz Cloud access to AWS S3, create an IAM policy. This policy should include specific actions and resources to facilitate the transfer of between Zilliz Cloud and your S3 bucket.

...
| --- | --- | --- | --- | --- | --- | --- |
| article_id (`INT64`) | auto-generated with enabled `auto_id` | [Query using Get](./get-and-scalar-query) | Y | N | N | N |
| title (`VARCHAR`) | article title | [Text Match](./text-match) | N | N | Y | N |
| timestamp (`INT32`) | publish date | [Filter by Partition Key](./use-partition-key) | N | Y | N | N |
| text (`VARCHAR`) | raw text of the article | [Multi-Vector Hybrid Search](./hybrid-search) | N | N | Y | input |
| text_dense_vector (`FLOAT_VECTOR`) | dense vector generated by a text embedding model | [Basic Vector Search](./single-vector-search) | N | N | N | N |
| text_sparse_vector (`SPARSE_FLOAT_VECTOR`) | sparse vector auto-generated by a built-in BM25 function | [Full Text Search](./full-text-search) | N | N | N | output |

...
notebook: FALSE
description: "Install Zilliz CLI and the agent integration that matches your local workflow. Zilliz supports agent integration through the Zilliz Plugin for Claude Code and OpenAI Codex, the Zilliz Skill for skill-compatible agents, and the Zilliz CLI for direct terminal or automation workflows. | BYOC"
type: shortcut

---
title: "Migrate to a New Embedding Model | Cloud"
...
notebook: FALSE
description: "This runbook explains how to migrate an existing collection from one embedding model to another without rebuilding the collection. You add a new vector field for the new embedding representation, migrate existing and incoming data to it, validate the new representation, and then move production search to the new field. | Cloud"
type: origin

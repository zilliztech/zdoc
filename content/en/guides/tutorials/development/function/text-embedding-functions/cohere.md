...
| embed-multilingual-v3.0 | 1,024 | 512 | Provides multilingual classification and embedding support. [See supported languages here](https://docs.cohere.com/docs/supported-languages). |
...
| embed-multilingual-v2.0 | 768 | 256 | Provides multilingual classification and embedding support. [See supported languages here](https://docs.cohere.com/docs/supported-languages). |

...
For longer source text, document passages, article bodies, tickets, or logs that should be stored and returned with entities, use a `TEXT` field instead. For details, refer to [TEXT Field](./use-text-field).

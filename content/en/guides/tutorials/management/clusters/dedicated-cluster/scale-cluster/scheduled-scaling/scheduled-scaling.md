...
notebook: FALSE
description: "Scheduled scaling lets you resize a Dedicated serving cluster at predefined times. Use it when your workload has recurring patterns, such as weekday business-hour traffic, weekend low-traffic periods, or predictable batch/query windows. | Cloud"
type: origin

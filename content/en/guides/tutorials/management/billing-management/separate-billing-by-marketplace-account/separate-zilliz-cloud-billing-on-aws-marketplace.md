...
| Model | Separates AWS Marketplace charges | Separates Zilliz usage by project or team | Best for |
| --- | --- | --- | --- |
| One organization per business unit | Yes | Yes | Teams that need AWS-side cost separation by member account. |

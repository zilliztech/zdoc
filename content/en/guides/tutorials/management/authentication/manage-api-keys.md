...
![Ec7wwrAnFhGIZFbJTWwc57bVn0f](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/Ec7wwrAnFhGIZFbJTWwc57bVn0f.png)
...
1. Navigate to the organization's **API Keys** page. Click **+ API Key**.
    ...
    ![create-api-key](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/create-api-key.png "create-api-key")

1. Enter the **API Key Name** and configure the **API Key Access**.

    ![Td6mboU99oiRhVxvbYecZJf1nGC](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/td6mbou99oirhvxvbyeczjf1ngc.png "Td6mboU99oiRhVxvbYecZJf1nGC")

    - **API Key Name:** The name should not exceed 64 characters.

    - **API Key Description (optional)**: The description of the API key to create. Up to 255 characters.
...
![KKONbcCa3o4qr9xJlhlcQMwinRd](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/kkonbcca3o4qr9xjlhlcqmwinrd.png "KKONbcCa3o4qr9xJlhlcQMwinRd")
...
1. Navigate to the organization's **API Keys** page. Click **...** in the actions column and click **Edit**.
    ...
    ![edit-api-key](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/edit-api-key.png "edit-api-key")

1. Edit the API Key **API Key Name** and the **API Key Access**.

    ![JXeubHidbokaTax90eZcrmA9nIg](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/jxeubhidbokatax90ezcrma9nig.png "JXeubHidbokaTax90eZcrmA9nIg")
...
- **Reset personal API keys**: you can reset your own personal API key only, regardless of your roles. 
    ...
    ![reset-personal-api-keys](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/reset-personal-api-keys.png "reset-personal-api-keys")

- **Reset customized API keys**: Only Organization Owners and Project Admins can reset customized API keys.

    ![reset-customized-api-keys](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/reset-customized-api-keys.png "reset-customized-api-keys")
...
![delete-customized-api-keys](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/delete-customized-api-keys.png "delete-customized-api-keys")

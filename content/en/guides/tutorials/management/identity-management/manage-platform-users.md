...
notebook: FALSE
description: "This guide introduces the two types of platform users in Zilliz Cloud organization users and project users, and explains how to manage them. | Cloud"
type: origin

---
title: "View SCIM-Synced Groups | Cloud"
...
notebook: FALSE
description: "After SCIM provisioning is configured, groups provisioned from your identity provider (IdP) appear in Zilliz Cloud as synced groups. You can view these groups in Access Control. | Cloud"
type: origin

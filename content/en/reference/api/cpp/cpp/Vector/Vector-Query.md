...
notebook: false
description: "Query with a set of criteria, and results in a list of records that match the query exactly. | Cloud"
type: docx
...
#### QueryResponse statistics\{#queryresponse-statistics}

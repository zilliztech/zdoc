...
notebook: false
description: "Get QueryIterator object based on scalar field(s) by filtering expression. Don't disconnect the MilvusClientV2 when the iterator is in using. assign the primary key field name to request. | Cloud"
type: docx

---
title: "クラスタ資格情報(SDK) | BYOC"
slug: /cluster-credentials-console
sidebar_label: "クラスタ資格情報(SDK)"
beta: FALSE
notebook: FALSE
description: "Zilliz Cloudは、Web UI上でクラスター資格情報を管理するだけでなく、資格情報管理用のSDKを提供することで機能を拡張しています。この統合により、柔軟性が向上し、Web UI単体よりも多くのカスタマイズオプションが提供されます。 | BYOC"
type: origin
...
## クラスターの役割とユーザーを一覧表示する{#list-cluster-roles-and-users}{#list-cluster-roles-and-users}
...
## クラスタユーザの作成{#create-a-cluster-user}{#create-a-cluster-user}
...
## ユーザーの資格情報を更新する{#update-a-user-credential}{#update-a-user-credential}
...
## 役割を説明する{#describe-a-role}{#describe-a-role}
...
## クラスターユーザーに役割を割り当てる{#assign-a-role-to-a-cluster-user}{#assign-a-role-to-a-cluster-user}
...
## ユーザーから役割を取り消す{#revoke-a-role-from-a-user}{#revoke-a-role-from-a-user}
...
## ユーザーを削除{#drop-a-user}{#drop-a-user}

...
## ステップ1: OktaでSAMLアプリの統合を作成する{#step-1-create-saml-app-integration-in-okta}{#1-oktasamlstep-1-create-saml-app-integration-in-okta}
...
## ステップ2: Zilliz CloudでSAML SSOを設定する{#step-2-configure-saml-sso-on-zilliz-cloud}{#2-zilliz-cloudsaml-ssostep-2-configure-saml-sso-on-zilliz-cloud}

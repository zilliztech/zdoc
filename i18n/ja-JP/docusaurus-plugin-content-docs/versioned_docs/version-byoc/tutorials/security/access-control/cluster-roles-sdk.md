...
## 役割を作成する{#create-a-role}{#create-a-role}
...
## ロールに組み込みの特権グループを付与する{#grant-a-built-in-privilege-group-to-a-role}{#grant-a-built-in-privilege-group-to-a-role}
...
## 役割を説明してください{#describe-a-role}{#describe-a-role}
...
## ロールから組み込みの特権グループを取り消す{#revoke-a-built-in-privilege-group-from-a-role}{#revoke-a-built-in-privilege-group-from-a-role}
...
## 役割を削除する{#drop-a-role}{#drop-a-role}

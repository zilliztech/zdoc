...
### VPCのIPアドレス範囲{#vpc-ip-address-ranges}{#vpcipvpc-ip-address-ranges}
...
### VPCエンドポイント{#vpc-endpoint}{#vpcvpc-endpoint}
...
### ステップ1: VPCとリソースを作成する{#step-1-create-vpc-and-resources}{#1-vpcstep-1-create-vpc-and-resources}
...
### ステップ2:セキュリティグループを作成する{#step-2-create-a-security-group}{#2step-2-create-a-security-group}
...
### ステップ3:（オプション）VPCエンドポイントを作成する{#step-3-optional-create-a-vpc-endpoint}{#3vpcstep-3-optional-create-a-vpc-endpoint}
...
### ステップ4: VPC情報をZilliz Cloudに提出する{#step-4-submit-vpc-information-to-zilliz-cloud}{#4-vpczilliz-cloudstep-4-submit-vpc-information-to-zilliz-cloud}

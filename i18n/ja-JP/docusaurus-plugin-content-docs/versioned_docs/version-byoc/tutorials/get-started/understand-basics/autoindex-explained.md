...
## 特徴と利点{#features-and-benefits}{#features-and-benefits}
...
### コスト効率{#cost-efficiency}{#cost-efficiency}
...
### 自律チューニング{#autonomous-tuning}{#autonomous-tuning}
...
## インデックスの構築と検索の設定{#index-building-and-search-settings}{#index-building-and-search-settings}
...
### `level`パラメータについて{#about-the-level-parameter}{#levelabout-the-level-parameter}

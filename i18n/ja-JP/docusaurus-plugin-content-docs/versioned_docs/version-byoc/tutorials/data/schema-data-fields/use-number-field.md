...
## サポートされている数値フィールドタイプ{#supported-number-field-types}{#supported-number-field-types}
...
## 数値フィールドを追加{#add-number-field}{#add-number-field}
...
### 数値フィルタリングによるベクトル検索{#vector-search-with-number-filtering}{#vector-search-with-number-filtering}

...
## 基本的な演算子{#basic-operators}{#basic-operators}
...
### 例:色でフィルタリングする{#example-filtering-by-color}{#example-filtering-by-color}
...
### 例: JSONフィールドのフィルタリング{#example-filtering-json-fields}{#jsonexample-filtering-json-fields}
...
### 例:配列フィールドのフィルタリング{#example-filtering-array-fields}{#example-filtering-array-fields}
...
## フィルター式のテンプレート{#filter-expression-templates}{#filter-expression-templates}
...
## データ型固有の演算子{#data-type-specific-operators}{#data-type-specific-operators}

Zilliz Cloudは、JSON、ARRAY、VARCHARフィールドなどの特定のデータタイプに対して高度なフィルタリング演算子を提供します。

### JSONフィールド固有の演算子{#json-field-specific-operators}{#jsonjson-field-specific-operators}
...
### ARRAYフィールド固有の演算子{#array-field-specific-operators}{#arrayarray-field-specific-operators}
...
### VARCHARフィールド固有の演算子{#varchar-field-specific-operators}{#varcharvarchar-field-specific-operators}

...
## ユークリッド距離（L2）{#euclidean-distance-l2}{#l2euclidean-distance-l2}
...
## インナープロダクト（IP）{#inner-product-ip}{#ipinner-product-ip}
...
## コサイン類似度{#cosine-similarity}{#cosine-similarity}
...
## ジャカード距離{#jaccard-distance}{#jaccard-distance}
...
## ハミング距離{#hamming-distance}{#hamming-distance}
...
## BM25の類似性{#bm25-similarity}{#bm25bm25-similarity}

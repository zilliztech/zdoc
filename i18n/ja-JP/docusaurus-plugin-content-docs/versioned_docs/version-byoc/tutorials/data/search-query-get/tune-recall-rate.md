...
![EcvqbDaXpoQ5BUxRfL0cyzk9ntc](/byoc/ja-JP/EcvqbDaXpoQ5BUxRfL0cyzk9ntc.png)
...
## 検索リクエストを設定する{#set-up-a-search-request}{#set-up-a-search-request}
...
## リコール率を調整する{#tune-recall-rate}{#tune-recall-rate}

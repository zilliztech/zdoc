...
![LNSEwUCiXhQs8ubUcfdcQyqTnff](/byoc/ja-JP/LNSEwUCiXhQs8ubUcfdcQyqTnff.png)
...
## 全文検索用のコレクションを作成する{#create-a-collection-for-full-text-search}{#create-a-collection-for-full-text-search}
...
### コレクションスキーマを定義する{#define-the-collection-schema}{#define-the-collection-schema}
...
### インデックスを設定する{#configure-the-index}{#configure-the-index}
...
### コレクションを作成する{#create-the-collection}{#create-the-collection}
...
## テキストデータを挿入{#insert-text-data}{#insert-text-data}
...
## 全文検索を実行する{#perform-full-text-search}{#perform-full-text-search}

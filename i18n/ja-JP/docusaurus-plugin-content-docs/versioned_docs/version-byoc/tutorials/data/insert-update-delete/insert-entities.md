...
beta: FALSE
notebook: FALSE
description: "コレクション内のエンティティは、同じフィールドセットを共有するデータレコードです。すべてのデータレコードのフィールド値がエンティティを形成します。このページでは、エンティティをコレクションに挿入する方法を紹介します。 | BYOC"
type: origin
...
## コレクションへのエンティティの挿入{#insert-entities-into-a-collection}{#insert-entities-into-a-collection}
...
## パーティションにエンティティを挿入する{#insert-entities-into-a-partition}{#insert-entities-into-a-partition}

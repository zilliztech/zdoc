...
## リストパーティション{#list-partitions}{#list-partitions}
...
## パーティションを作成{#create-partition}{#create-partition}
...
## 特定のパーティションを確認する{#check-for-a-specific-partition}{#check-for-a-specific-partition}
...
## パーティションのロードとリリース{#load-and-release-partitions}{#load-and-release-partitions}

1つまたは特定のパーティションを個別にロードまたは解放できます。

### パーティションをロードする{#load-partitions}{#load-partitions}
...
### リリースパーティション{#release-partitions}{#release-partitions}
...
## パーティション内のデータ操作{#data-operations-within-partitions}{#data-operations-within-partitions}

### 図形の挿入と削除{#insert-and-delete-entities}{#insert-and-delete-entities}
...
## ドロップパーティション{#drop-partition}{#drop-partition}

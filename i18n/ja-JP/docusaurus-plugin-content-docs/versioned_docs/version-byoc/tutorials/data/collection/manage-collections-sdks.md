...
## (オプション)インデックスパラメータの設定{#set-index-parameters}{#set-index-parameters}
...
### シャード番号の設定{#set-shard-number}{#set-shard-number}
...
### mmapを有効にする{#enable-mmap}{#mmapenable-mmap}
...
### セットコレクションTTL{#set-collection-ttl}{#ttlset-collection-ttl}

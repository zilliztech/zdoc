...
## 組織にユーザーを招待する{#invite-a-user-to-your-organization}{#invite-a-user-to-your-organization}
...
### 組織の役割{#organization-roles}{#organization-roles}
...
![invite-user-to-org-byoc](/byoc/ja-JP/invite-user-to-org-byoc.png)
...
![revoke-or-resend-org-invitation](/byoc/ja-JP/revoke-or-resend-org-invitation.png)

![revoke-or-resend-org-invitation-byoc](/byoc/ja-JP/revoke-or-resend-org-invitation-byoc.png)

## 組織のユーザーの役割を編集する{#edit-the-role-of-an-organization-user}{#edit-the-role-of-an-organization-user}

ユーザーが招待を受け入れて組織に参加すると、必要に応じて役割を調整できます。

Organizationユーザのロールを編集するには、**Organizationオーナー**である必要があります。

![edit-user-role-or-remove-org-user-byoc](/byoc/ja-JP/edit-user-role-or-remove-org-user-byoc.png)

## 組織のユーザーを削除する{#remove-an-organization-user}{#remove-an-organization-user}
...
## 組織を離れる{#leave-an-organization}{#leave-an-organization}
...
![leave-organization-byoc](/byoc/ja-JP/leave-organization-byoc.png)

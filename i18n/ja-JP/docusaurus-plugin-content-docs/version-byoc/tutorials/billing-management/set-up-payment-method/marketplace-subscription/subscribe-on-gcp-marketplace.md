---
title: "Google Cloud Marketplace での購読 | BYOC"
slug: /subscribe-on-gcp-marketplace
sidebar_key: subscribe-on-gcp-marketplace
sidebar_label: "Google Cloud Marketplace"
beta: FALSE
notebook: FALSE
description: "このガイドでは、GCP Marketplace での Zilliz Cloud の購読プロセスをステップバイステップで説明し、料金体系についても解説します。 | BYOC"
type: origin
...
詳細については [支払い & 請求](./payment-billing#payment-methods) を参照してください。

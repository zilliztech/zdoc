...
<table>
   ...
   <tr>
     ...
     <td><p>コレクションのデータを特定の期間後に削除する必要がある場合は、Time-To-Live(TTL)を秒単位で設定することを検討してください。TTLがタイムアウトすると、Zilliz Cloudはコレクションからすべてのエンティティを削除します。</p><p>削除は非同期であり、削除が完了する前に検索とクエリが可能であることを示しています。</p><p>詳細は<a href="null">Set Collection TTL</a>を参照してください。</p></td>
   </tr>
   <tr>

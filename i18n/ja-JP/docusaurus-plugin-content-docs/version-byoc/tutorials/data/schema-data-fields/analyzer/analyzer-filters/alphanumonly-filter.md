---
title: "Alphanumonlyという名前です。 | BYOC"
slug: /alphanumonly-filter
sidebar_label: "Alphanumonlyという名前です。"
beta: FALSE
notebook: FALSE
description: "`alphanumonly`フィルターは、非ASCII文字を含むトークンを削除し、英数字のみを保持します。このフィルターは、特殊文字や記号を除いて、基本的な文字と数字のみが関連するテキストを処理するのに役立ちます。 | BYOC"
type: origin

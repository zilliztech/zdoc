...
- 5 GB のストレージ（100 万個の 768 次元ベクトルに十分な容量です。）
...
- クレジット付与後、最初の 3 日以内にクレジットが消費されなかった場合。

- クレジットの 60% が消費された場合。

- クレジットの有効期限が 3 日未満になった場合。

- 有効な支払い方法がないままトライアルが終了し、組織が凍結された場合。

- トライアルの終了が近づき、Serverless および Dedicated クラスターの削除が予定された場合。

...
![CyYAbqi1doKYpzxzJNccXm4Ynmf](/img/CyYAbqi1doKYpzxzJNccXm4Ynmf.png)
...
Zilliz BYOCのデプロイオプションの詳細については、「[BYOCの概要](/ja-JP/docs/byoc/byoc-intro)」を参照してください。デプロイ手順と強化されたプロジェクト管理機能については、「[AWSでBYOCをデプロイする](/ja-JP/docs/byoc/deploy-byoc-aws)」と「[AWSでBYOC-Iをデプロイする](/ja-JP/docs/byoc-i/deploy-byoc-aws)」を参照してください。 

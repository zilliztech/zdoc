...
notebook: FALSE
description: "Zilliz Cloud の大規模なアップデートが一般提供開始となったことをお知らせします。このリリースでは、Zilliz Cloud サービス向けの新しいコンソールが導入され、新しいクラウドリージョンがサポートされ、プライベートリンクによる安全なクラスターアクセスが可能になりました。 | Cloud"
type: origin
...
Zilliz Cloud の大規模なアップデートが一般提供開始となったことをお知らせします。このリリースでは、Zilliz Cloud サービス向けの新しいコンソールが導入され、新しいクラウドリージョンがサポートされ、プライベートリンクによる安全なクラスターアクセスが可能になりました。
...
- 大容量ファイルからのデータインポート
    ...
    Zilliz Cloud が大容量ファイルからのデータインポートをサポートするようになったことをお知らせします。最大 512 MB のファイルからコレクションにデータを一括挿入できます。ファイルは S3 バケットまたはローカルディスクのいずれにも配置できます。

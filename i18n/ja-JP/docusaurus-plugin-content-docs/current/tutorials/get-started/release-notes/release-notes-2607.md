...
<Grid columnSize="2" widthRatios="15,84">
    ...
    <div>
        ...
        - **オンデマンドクラスターの auto-suspend のカスタマイズ:** クラスターの作成後に、オンデマンドクラスターの auto-suspend 間隔を更新できるようになりました。これにより、ワークロードパターンの変化に応じて、クエリの即応性とアイドル時のコンピュートコストのバランスをより細かく制御できます。詳細は、[オンデマンドクラスター](/docs/on-demand-cluster) を参照してください。

...
1. [Create an Events API v2 integration](https://support.pagerduty.com/docs/services-and-integrations#create-a-generic-events-api-integration) を実行してインテグレーションキーを取得します。インテグレーションキーは `c55ec4de243e440bd0e921750bdfxxxx` の形式です。

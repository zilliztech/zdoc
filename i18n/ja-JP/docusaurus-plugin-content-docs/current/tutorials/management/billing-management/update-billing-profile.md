...
notebook: FALSE
description: "請求先プロファイルには、請求、請求書、税務記録に使用される組織情報と連絡先情報が含まれます。請求書が正しい会社名、住所、連絡先情報で発行されるよう、請求先プロファイルを最新の状態に保ってください。 | Cloud"
type: origin
...
すでに発行済みの請求書は変更されません。既存の請求書の情報を更新する必要がある場合は、finance@zilliz.com まで Zilliz Finance team にお問い合わせください。

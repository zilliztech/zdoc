---
title: "ASCII折りたたみ | Cloud"
slug: /ascii-folding-filter
sidebar_label: "ASCII折りたたみ"
beta: FALSE
notebook: FALSE
description: "`asciifolding`フィルターは、基本ラテン文字Unicodeブロック以外の文字をASCIIに変換します。例えば、`í`のような文字を`i`に変換することで、特に多言語コンテンツに対してテキスト処理をより簡単かつ一貫性のあるものにします。 | Cloud"
type: origin

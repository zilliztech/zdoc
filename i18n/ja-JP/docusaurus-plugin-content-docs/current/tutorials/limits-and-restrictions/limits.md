...
beta: FALSE
notebook: FALSE
description: "このページでは、Zilliz Cloudプラットフォームの制限に関する情報を提供しています。これらの制限に関連する問題を報告する必要がある場合は、リクエストを送信にお問い合わせください。 | Cloud"
type: origin
...
このページでは、Zilliz Cloudプラットフォームの制限に関する情報を提供しています。これらの制限に関連する問題を報告する必要がある場合は、[リクエストを送信](https://support.zilliz.com/hc/en-us)にお問い合わせください。
...
<table>
   ...
   <tr>
     <td><p>組織について</p></td>
     <td><p>1</p></td>
     <td><p>アカウント登録が完了すると、Zilliz Cloudは自動的に1つの組織を作成します。もし組織が必要な場合は、<a href="http://support.zilliz.com">サポートチケットを作成する</a>をクリックしてください。ユーザーは複数の組織に参加することができます。</p></td>
   </tr>
   <tr>
     <td><p>プロジェクト</p></td>
     <td><p>100</p></td>

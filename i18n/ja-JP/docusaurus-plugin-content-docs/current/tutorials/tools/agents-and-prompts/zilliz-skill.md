...
notebook: FALSE
description: "Zilliz Skills は、Zilliz Cloud を操作するための特化機能を Claude Code に提供する、再利用可能なスキルモジュールです。 | Cloud"
type: origin
...
Skills は、Claude Code の機能を拡張するモジュール型の機能です。[Zilliz Skills リポジトリ](https://github.com/zilliztech/zilliz-skill)には、一般的な Zilliz Cloud 操作向けの事前構築済みスキルが含まれています。

---
title: "Agent Plugins and Extensions | Cloud"
...
notebook: FALSE
description: "このプロンプトを AI 搭載 IDE で使用すると、AI アシスタントが Zilliz Cloud 機能を正しく効率的に実装できるようになります。 | Cloud"
type: origin
...
このプロンプトを AI 搭載 IDE で使用すると、AI アシスタントが Zilliz Cloud 機能を正しく効率的に実装できるようになります。

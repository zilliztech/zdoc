---
title: "マイクロソフトエントラ | Cloud"
slug: /single-sign-on-with-microsoft-entra
sidebar_label: "マイクロソフトエントラ"
beta: CONTACT SALES
notebook: FALSE
description: "マイクロソフトエントラは、ハイブリッドおよびマルチクラウド環境でセキュリティ、コンプライアンス、およびユーザーエクスペリエンスを向上させる統合IDおよびアクセス管理ソリューションです。Zilliz Cloudを使用すると、SAMLプロトコルを介してMicrosoft Entraとシングルサインオン（SSO）を構成できます。 | Cloud"
type: origin

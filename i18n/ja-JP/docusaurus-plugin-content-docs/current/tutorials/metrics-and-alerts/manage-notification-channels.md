...
1. [Zilliz Cloudコンソール](https://cloud.zilliz.com/signup)で、Webhook通知チャネルを構成します。

    1. 組织またはプロジェクトアラートページの**アラート設定**タブに移動します。
    ...
    1. 表示されるダイアログボックスで、**送信先**フィールドの**+ チネル**をクリックし、ドロップダウンリストから**Webhook**を選択します。
...
![test-connectivity](/img/test-connectivity.png "test-connectivity")

...
<table>
   ...
   <tr>
     ...
     <td><p>無料クレジットの残高が10ドルを下回ると、トリガー<strong>警告</strong>が表示されます。</p></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td><p>残高が100ドルを下回ったときに<strong>CRITICAL</strong>アラートをトリガーします。</p></td>
   </tr>
   <tr>
     <td><p>ご利用量</p></td>
     <td><p>&#36;</p></td>
     ...
     <td><p>使用量が100ドルを超えると、トリガー<strong>警告</strong>アラートが表示されます。</p></td>
   </tr>
</table>

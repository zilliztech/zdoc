...
## ユーザーと役割{#users-and-roles}{#users-and-roles}
...
## クラスタ{#clusters}{#clusters}

### クラスタ数{#number-of-clusters}{#number-of-clusters}
...
<table>
   ...
   <tr>
     <td><p>専用（スタンダード）</p></td>
     <td><p>CU体格*レプリカ数&lt;=32</p></td>
     <td><p>コンソールでは、1つのクラスターに対して最大32個のCUを作成できます。</p><p>ただし、レプリカを追加する場合はCU体格*レプリカ数&lt;=32となります。</p></td>
   </tr>
   <tr>
     <td><p>専用(エンタープライズ)</p></td>
     <td><p>CU体格*レプリカ数&lt;=25 6</p></td>
     <td><p>コンソールでは、1つのクラスターに対して最大256個のCUを作成できます。</p><p>ただし、レプリカを追加する場合はCU体格*Replica Count&lt;=256となります。</p></td>
   </tr>
</table>
...
<table>
   ...
   <tr>
     ...
     <td><p>&lt;= 256</p></td>
     <td><p>クラスターCU体格*レプリカ数は256を超えてはいけません。</p></td>
   </tr>
</table>
...
### パイプラインの数{#number-of-pipelines}{#number-of-pipelines}
...
### パイプラインの使用{#pipeline-usage}{#pipeline-usage}
...
<table>
   ...
   <tr>
     <td><p>フリークラスタ</p></td>
     <td><p>1,024</p></td>
     <td><p>1つの無料クラスタでは、1つのコレクションにつき最大1,024個のパーティションを作成できます。</p></td>
   </tr>
   <tr>
     <td><p>サーバーレスクラスター</p></td>
     <td><p>1,024</p></td>

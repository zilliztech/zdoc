---
title: "データベースエンドポイントを使用してMilvusからZilliz Cloudへの移行 | Cloud"
slug: /via-endpoint
...
## 始める前に{#migrate-from-milvus-via-database-endpoint}{#migrate-from-milvus-via-database-endpoint}
...
## データベースエンドポイントを介してMilvusから移行する{#migrate-from-milvus-via-database-endpoint}{#milvusmigrate-from-milvus-via-database-endpoint}

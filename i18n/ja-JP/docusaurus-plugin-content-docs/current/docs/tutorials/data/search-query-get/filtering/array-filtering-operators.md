...
## 利用可能なARRAYオペレーター{#available-array-operators}{#arrayavailable-array-operators}
...
## 配列を含む{#arraycontains}{#arraycontains}
...
## すべてを含む配列{#arraycontainsall}{#arraycontainsall}
...
## 配列の内容{#arraycontainsany}{#arraycontainsany}

...
## QueryIteratorを使う{#use-queryiterator}{#queryiteratoruse-queryiterator}
...
## パーティション内のクエリ{#queries-in-partitions}{#queries-in-partitions}

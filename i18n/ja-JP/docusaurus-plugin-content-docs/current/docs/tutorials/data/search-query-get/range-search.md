...
![JrMzwgnfvhxaFob5s5LcxxUxnPc](/img/ja-JP/JrMzwgnfvhxaFob5s5LcxxUxnPc.png)
...
以下のコードスニペットでは、`半径`を`0.4`、`range_filter`を`0.6`に設定して、Zilliz Cloudは、クエリベクトルとの距離またはスコアが**0.4**から0.**6**の範囲内にあるすべてのエンティティを返します。

...
## 例:ニュース検索{#an-example-news-search}{#an-example-news-search}
...
## サンプルスキーマの実装方法{#how-to-implement-the-example-schema}{#how-to-implement-the-example-schema}
...
### インデックスを定義{#define-index}{#define-index}
...
## その他の考慮事項{#other-considerations}{#other-considerations}

### インデックスの読み込み{#loading-index}{#loading-index}
...
### マルチテナントのデータモデルを定義する方法{#how-to-define-data-model-for-multi-tenancy}{#how-to-define-data-model-for-multi-tenancy}

...
## スキーマの作成{#create-schema}{#create-schema}
...
## プライマリフィールドを追加{#add_primary_field}{#addprimaryfield}
...
## ベクトルフィールドを追加{#add-vector-fields}{#add-vector-fields}
...
## スカラーフィールドを追加{#add-scalar-fields}{#add-scalar-fields}
...
### 文字列フィールドを追加{#add-string-fields}{#add-string-fields}
...
### 数値フィールドを追加{#add-number-fields}{#add-number-fields}
...
### ブールフィールドを追加{#add-boolean-fields}{#add-boolean-fields}
...
### JSONフィールドを追加{#add-json-fields}{#jsonadd-json-fields}
...
### 配列フィールドを追加{#add-array-fields}{#add-array-fields}

...
## AWS簡易ストレージサービス(S3){#aws-simple-storage-service-s3}{#awss3aws-simple-storage-service-s3}
...
## Google Cloudストレージ{#google-cloud-storage}{#google-cloudgoogle-cloud-storage}
...
## Azure Blobストレージ{#azure-blob-storage}{#azure-blobazure-blob-storage}

...
## コネクターの理解{#understanding-connectors}{#understanding-connectors}
...
### なぜコネクタを使用するのですか?{#why-use-a-connector}{#why-use-a-connector}
...
## コネクタの作成{#create-connector}{#create-connector}
...
## コネクタの管理{#manage-connector}{#manage-connector}

コネクタを効率的に管理することは、スムーズなデータ統合過程を維持するために不可欠です。このガイドでは、コネクタの管理方法について詳しく説明します。

### コネクタを有効または無効にする{#enable-or-disable-a-connector}{#enable-or-disable-a-connector}
...
### 手動スキャンをトリガーする{#trigger-a-manual-scan}{#trigger-a-manual-scan}
...
### コネクタの設定{#configure-a-connector}{#configure-a-connector}
...
### コネクタを落とす{#drop-a-connector}{#drop-a-connector}
...
### コネクタログの表示{#view-connector-logs}{#view-connector-logs}
...
### パイプライン内の関連コネクタを表示する{#view-related-connectors-in-a-pipeline}{#view-related-connectors-in-a-pipeline}

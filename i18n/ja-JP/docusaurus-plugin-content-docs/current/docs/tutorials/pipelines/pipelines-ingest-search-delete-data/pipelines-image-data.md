...
## イメージデータを取り込む{#ingest-image-data}{#ingest-image-data}

データを取り込むには、まず取り込みパイプラインを作成してから実行する必要があります。

### イメージ取り込みパイプラインを作成する{#create-image-ingestion-pipeline}{#create-image-ingestion-pipeline}
...
### イメージ取り込みパイプラインを実行する{#run-image-ingestion-pipeline}{#run-image-ingestion-pipeline}
...
## 画像データを検索する{#search-image-data}{#search-image-data}
...
### 逆画像検索を行う{#conduct-a-reverse-image-search}{#conduct-a-reverse-image-search}

#### 画像検索パイプラインの作成{#create-image-search-pipeline}{#create-image-search-pipeline}
...
#### 画像検索パイプラインの実行{#search-image-by-text}{#search-image-by-text}
...
### テキストで画像を検索する{#search-image-by-text}{#search-image-by-text}
...
#### 画像検索パイプラインの実行{#run-image-search-pipeline}{#run-image-search-pipeline}
...
## 画像データの削除{#delete-image-data}{#delete-image-data}
...
### イメージ削除パイプラインの作成{#create-image-deletion-pipeline}{#create-image-deletion-pipeline}
...
### イメージ削除パイプラインの実行{#run-image-deletion-pipeline}{#run-image-deletion-pipeline}

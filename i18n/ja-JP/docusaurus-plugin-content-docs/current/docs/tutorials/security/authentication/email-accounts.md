...
## プロフィール情報を変更する{#modify-your-profile-information}{#modify-your-profile-information}
...
## アカウントのメールアドレスを更新{#update-account-email-address}{#update-account-email-address}
...
## アカウントのパスワードを変更する{#update-account-email-address}{#update-account-email-address}

## MFAの有効化と無効化{#enable-and-disable-mfa}{#mfaenable-and-disable-mfa}

詳細については、[MFA](./multi-factor-auth)を参照してください。

## ログイン方法を切り替える{#switch-login-method}{#switch-login-method}
...
### パスワードログインからサードパーティログインに切り替える{#switch-from-password-login-to-third-party-login}{#switch-from-password-login-to-third-party-login}
...
### サードパーティログインからパスワードログインに切り替える{#switch-from-third-party-login-to-password-login}{#switch-from-third-party-login-to-password-login}
...
### サードパーティのログインを切り替える{#switch-between-third-party-logins}{#switch-between-third-party-logins}
...
## サードパーティ認証からのリンク解除{#unlink-from-third-party-authentication}{#unlink-from-third-party-authentication}

### Googleアカウントからのリンクを解除{#unlink-from-your-google-account}{#googleunlink-from-your-google-account}
...
### GitHubアカウントからのリンク解除{#unlink-from-your-github-account}{#githubunlink-from-your-github-account}
...
## アカウントを閉じてください{#close-your-account}{#close-your-account}

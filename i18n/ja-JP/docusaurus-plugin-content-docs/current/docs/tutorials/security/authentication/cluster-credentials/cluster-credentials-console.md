---
title: "Cluster Credentials (Console) | Cloud"
slug: /cluster-credentials-console
sidebar_label: "Cluster Credentials (Console)"
beta: FALSE
notebook: FALSE
description: "Zilliz Cloud authenticates your identity using a cluster credential or an API key. This guide introduces authentication with cluster credentials. | Cloud"
type: origin

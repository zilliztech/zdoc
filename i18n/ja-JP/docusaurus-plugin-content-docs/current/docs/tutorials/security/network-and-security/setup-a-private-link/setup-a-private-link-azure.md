...
### エンドポイントサービスを確立する{#establish-and-endpoint-service}{#establish-and-endpoint-service}
...
## DNSの設定{#set-up-dns}{#dnsset-up-dns}

Zilliz Cloudが割り当てたプライベートリンクを使用してクラスタをアクセス可能にする前に、DNSを設定する必要があります。

### AzureポータルでプライベートDNSゾーンを作成する{#create-a-private-dns-zone-on-the-azure-portal}{#azurednscreate-a-private-dns-zone-on-the-azure-portal}
...
### プライベートDNSゾーンを仮想ネットワークにリンクする{#link-the-private-dns-zone-to-your-virtual-network}{#dnslink-the-private-dns-zone-to-your-virtual-network}

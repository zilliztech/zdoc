...
## フリークラスタ{#free-cluster}{#free-cluster}
...
## サーバーレスクラスタ{#serverless-cluster}{#serverless-cluster}
...
### クラスタに接続{#connect-to-cluster}{#connect-to-cluster}
...
### 専用クラスタへの移行{#migrate-to-dedicated-cluster}{#migrate-to-dedicated-cluster}
...
## 専用クラスタ{#dedicated-cluster}{#dedicated-cluster}

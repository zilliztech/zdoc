...
### サーバーレスGA{#serverless-ga}{#gaserverless-ga}
...
### Zilliz CloudでMilvus 2.4. xの新機能がGAしました。{#milvus-24x-new-features-ga-on-zilliz-cloud}{#zilliz-cloudmilvus-24-xgamilvus-24x-new-features-ga-on-zilliz-cloud}
...
#### マルチベクトル&ハイブリッド検索{#multi-vector-and-hybrid-search}{#andmulti-vector-and-hybrid-search}
...
#### メタデータのフィルタリングと部分文字列のマッチングの改善{#improved-metadata-filtering-and-substring-matching}{#improved-metadata-filtering-and-substring-matching}
...
#### グループ検索{#grouping-search}{#grouping-search}
...
#### Float 16とBFloatベクトルデータ型{#float16-and-bfloat-vector-datatype}{#float-16bfloatfloat16-and-bfloat-vector-datatype}
...
### マルチレプリカ{#multi-replica}{#multi-replica}
...
### マイグレーションサービス{#migration-service}{#migration-service}
...
### バックアップ/復元/移行/ジョブRESTful API{#backuprestoremigrationjobs-restful-api}{#yuanrestful-apibackuprestoremigrationjobs-restful-api}
...
### その他の機能強化{#other-enhancements}{#other-enhancements}

...
## BYOC–セキュリティと許可管理をさらに改善{#byoc-a-brand-new-solution-for-data-security-and-permission-control}{#byoc-byoc-a-brand-new-solution-for-data-security-and-permission-control}
...
## 新しいリージョンが利用可能になりました: GCP us-central 1(lowa){#new-region-available-gcp-us-central1-lowa}{#gcp-us-central-1lowanew-region-available-gcp-us-central1-lowa}
...
## データベースレイヤーのサポート{#support-for-database-layer}{#support-for-database-layer}
...
## 拡張データ容量に対するmmapサポート{#mmap-support-for-expanded-data-capacity}{#mmapmmap-support-for-expanded-data-capacity}
...
## コレクションレベルのRBACサポート{#collection-level-rbac-support}{#rbaccollection-level-rbac-support}
...
## 高いリコール検索{#high-recall-search}{#high-recall-search}
...
## リコール率の推定{#recall-rate-estimation}{#recall-rate-estimation}

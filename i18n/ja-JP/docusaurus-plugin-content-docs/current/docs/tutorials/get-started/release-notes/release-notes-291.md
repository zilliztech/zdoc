...
### RESTful API v 2とは{#restful-api-v2}{#restful-api-v-2restful-api-v2}
...
### 専用クラスタの自動スケーリング[プライベートプレビュー]{#auto-scaling-for-dedicated-clusters-private-preview}{#auto-scaling-for-dedicated-clusters-private-preview}

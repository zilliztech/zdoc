...
### Azure Marketplace Azureブログ{#azure-marketplace}{#azure-marketplace-azureazure-marketplace}
...
### メトリクスモニタリング用API{#api-for-metrics-monitoring}{#apiapi-for-metrics-monitoring}
...
### クロスクラウドデータのインポートと移行の強化{#cross-cloud-data-import-and-migration-enhancement}{#cross-cloud-data-import-and-migration-enhancement}

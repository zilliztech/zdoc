...
## 新しいAWSリージョン:フランクフルト(aws-eu-central-1)が利用可能になりました。{#new-aws-region-frankfurt-aws-eu-central-1-now-live}{#awsaws-eu-central-1new-aws-region-frankfurt-aws-eu-central-1-now-live}
...
## 革新的なベータ機能{#innovative-beta-features}{#innovative-beta-features}

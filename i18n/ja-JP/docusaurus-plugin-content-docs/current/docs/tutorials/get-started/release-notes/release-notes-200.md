...
## Zilliz Cloudサーバーレスベクターデータベースサービスのローンチ{#zilliz-cloud-serverless-vector-database-service-launch}{#zilliz-cloudzilliz-cloud-serverless-vector-database-service-launch}
...
## Zilliz Cloudのプラン階層: Starter、Standard、Enterprise、およびSelf-Hosted{#zilliz-clouds-plan-tiers-starter-standard-enterprise-and-self-hosted}{#zilliz-cloud-starterstandardenterpriseself-hostedzilliz-clouds-plan-tiers-starter-standard-enterprise-and-self-hosted}
...
## 組織、コラボレーション、RBAC{#organization-collaboration-and-rbac}{#rbacorganization-collaboration-and-rbac}
...
## パーティションキー{#partition-key}{#partition-key}
...
## 動的スキーマ{#dynamic-schema}{#dynamic-schema}
...
## JSONタイプのサポート{#json-type-support}{#jsonjson-type-support}

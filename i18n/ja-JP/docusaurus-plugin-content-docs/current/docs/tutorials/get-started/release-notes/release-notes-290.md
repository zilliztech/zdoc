...
## Zilliz CloudでMilvus 2.4. xの新機能が利用可能になりました。{#milvus-24x-new-features-available-on-zilliz-cloud}{#zilliz-cloudmilvus-24-xmilvus-24x-new-features-available-on-zilliz-cloud}
...
### マルチ埋め込み&ハイブリッド検索{#multi-embedding-and-hybrid-search}{#andmulti-embedding-and-hybrid-search}
...
### インバーテッドインデックスとファジーマッチ{#inverted-index-and-fuzzy-match}{#inverted-index-and-fuzzy-match}
...
### 改良されたMilvusClientインターフェース{#refined-milvusclient-interfaces}{#milvusclientrefined-milvusclient-interfaces}
...
### エンハンスメント{#enhancements}{#enhancements}

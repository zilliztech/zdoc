...
- [少なくとも1つのクラスタを作成](/docs/create-cluster)してください。Zilliz Cloudは、[無料](null)のクラスタを提供しています。これにより、Zilliz Cloudベクトルデータベースをすばやく利用できます。
...
### VectorDBBenchのインストールと起動{#vectordbbench}

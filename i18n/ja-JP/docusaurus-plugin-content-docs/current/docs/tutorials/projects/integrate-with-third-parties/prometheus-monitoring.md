...
## Zilliz CloudメトリクスをスクレイピングするためにPrometheusを設定する{#configure-prometheus-to-scrape-zilliz-cloud-metrics}{#zilliz-cloudprometheusconfigure-prometheus-to-scrape-zilliz-cloud-metrics}
...
## スクレイピングされたメトリックの例{#example-scraped-metrics}{#example-scraped-metrics}
...
## Zilliz Cloudのメトリックラベル{#zilliz-cloud-metric-labels}{#zilliz-cloudzilliz-cloud-metric-labels}
...
## 利用可能なメトリック{#available-metrics}{#available-metrics}
...
## Prometheusクエリの例{#example-prometheus-queries}{#prometheusexample-prometheus-queries}

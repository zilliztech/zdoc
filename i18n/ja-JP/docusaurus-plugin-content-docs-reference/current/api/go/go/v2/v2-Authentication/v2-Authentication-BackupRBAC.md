...
notebook: false
description: "この操作は、users、roles、grants、および privilege groups を含む RBAC メタデータの完全バックアップを作成します。 | Go | v2"
type: docx
...
この操作は、users、roles、grants、および privilege groups を含む RBAC メタデータの完全バックアップを作成します。
...
users、roles、grants、および privilege groups を含む完全な RBAC メタデータのスナップショットを返します。操作が失敗した場合は error を返します。

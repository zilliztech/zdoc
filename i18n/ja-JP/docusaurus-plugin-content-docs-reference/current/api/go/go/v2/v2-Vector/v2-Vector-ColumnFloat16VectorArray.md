...
notebook: false
description: "行が共有次元を持つ Float16 値を含む ArrayOfVector 列を表します。 | Go | v2"
type: docx
...
行が共有次元を持つ Float16 値を含む ArrayOfVector 列を表します。
...
struct 配列フィールド内の ArrayOfVector float16-vector データ用の列型です。

---
title: "API の提供状況 | BYOC"
slug: /api-comparison
sidebar_label: "API の提供状況"
beta: FALSE
added_since: FALSE
last_modified: FALSE
deprecate_since: FALSE
notebook: FALSE
description: "Zilliz Cloud は、より優れたユーザー体験を提供するために、Milvus とは若干異なる動作をします。この記事は、API の観点から 2 つのプラットフォームの違いを明確にすることを目的としています。 | BYOC"
type: origin
...
以下の表では、サービスティアごとの API の提供状況を比較しています。[Bring Your Own Cloud (BYOC)](/docs/byoc/byoc-intro) ソリューションの API 提供状況は、一部の例外を除き、**Standard and Enterprise** ティアと一致していることに注意してください。詳細については、[Zilliz Cloud Limits](./limits) を参照してください。

---
title: "Zilliz Claude Code Plugin の例 | BYOC"
...
notebook: FALSE
description: "このガイドでは、自然言語を使用してインフラストラクチャをプロビジョニングし、データ操作を実行し、クラスター間でデータをバックアップおよび復元し、クラスターのセキュリティのためにアクセス制御を実装する、より多くの例を紹介します。 | BYOC"
type: origin
...
このガイドでは、自然言語を使用してインフラストラクチャをプロビジョニングし、データ操作を実行し、クラスター間でデータをバックアップおよび復元し、クラスターのセキュリティのためにアクセス制御を実装する、より多くの例を紹介します。
...
**シナリオ**: チームメンバー向けに RBAC をセットアップする
...
さらに例を確認したい場合は、[Zilliz CLI リファレンス](/reference/cli/cli/overview) ドキュメントをお読みください。
